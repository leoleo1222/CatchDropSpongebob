...
def display_score():
    ...
    if remaining_time.total_seconds() <= 0:
            remaining_time = timedelta(seconds=0)  # Set remaining time to 0 if it's negative
...
def draw():
    global bob_x, current_stage, current_round, drop_speed, start_time, timer_duration, stage_notification, notification_timer
